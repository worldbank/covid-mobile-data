...
if (Sys.info()[["user"]] == "robmarty") {
  setwd("~/Documents/Github/covid-mobile-data/dashboard-dataviz/dashboard")
}

if (Sys.info()[["user"]] == "WB521633") {
  setwd("C:/Users/wb521633/Documents/Github/covid-mobile-data/dashboard-dataviz/dashboard"
  )
}

if (Sys.info()[["user"]] == "wb519128") {
  setwd("C:/Users/wb519128/GitHub/covid-mobile-data/dashboard-dataviz/dashboard"
  )
}
