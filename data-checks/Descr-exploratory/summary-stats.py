...
DATA_panel = DATA_POC + 'panel_indicators/clean/'

#-----------------------------------------------------------------#
#### Load data

i1 = pd.read_csv(DATA_panel + 'i1_admin3.csv') # Number of calls
i3 = pd.read_csv(DATA_panel + 'i3_admin3.csv') # number of users
i5 = pd.read_csv(DATA_panel + 'i5_admin3.csv') # orgin and destination 
i52 = pd.read_csv(DATA_panel + 'i5_admin2.csv') # orgin and destination 

i7 = pd.read_csv(DATA_panel + 'i7_admin3.csv') # distance travelled
...
sum(i5['region_from'] == i5['region_to'])
